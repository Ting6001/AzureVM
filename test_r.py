...
robjects.r.source("./powerApp_func_multi_v5_test.R")
...
for i, project_code_name in enumerate(tqdm(['1PD062550001,VT306-C,21498.20,3.17'])): # 23D000、1PD05R550001,  23R000、1PD062550001
